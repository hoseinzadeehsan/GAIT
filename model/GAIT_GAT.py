...
metric_dir = join(configs.root_dir, 'results', 'GAT')
...
def train(args, model, train_dataset, validation_dataset):
    ...
    adr = os.path.join(configs.root_dir, 'saved_models_GAT',
                       args.model_name + args.data_name + '_{}_{}_{}_{}'.format(args.num_layers, args.num_hidden,
                                                                                args.num_heads, args.num_out_heads))
    adr_last = os.path.join(configs.root_dir, 'saved_models_GAT',
                            args.model_name + args.data_name + 'last_{}_{}_{}_{}'.format(args.num_layers,
                                                                                         args.num_hidden,
                                                                                         args.num_heads,
                                                                                         args.num_out_heads))
    adr_state_dict = os.path.join(configs.root_dir, 'saved_models_GAT',
                                  args.model_name + args.data_name + '_state_dict_{}_{}_{}_{}'.format(args.num_layers,
                                                                                                      args.num_hidden,
                                                                                                      args.num_heads,
                                                                                                      args.num_out_heads))
    adr_state_dict_best = os.path.join(configs.root_dir, 'saved_models_GAT',
                                       args.model_name + args.data_name + '_state_dict_best_{}_{}_{}_{}'.format(
                                           args.num_layers, args.num_hidden, args.num_heads, args.num_out_heads))
...
def main(args):
    ...
    adr_best_model = os.path.join(configs.root_dir, 'saved_models_GAT',
                                  args.model_name + args.data_name + '_state_dict_best_{}_{}_{}_{}'.format(
                                      args.num_layers, args.num_hidden, args.num_heads, args.num_out_heads))
...
if __name__ == '__main__':
    ...
    parser.add_argument("--max_col", type=int, default=20,
    ...
    parser.add_argument("--in-drop", type=float, default=0.05,
